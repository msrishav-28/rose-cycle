...
export default function RosecycleLandinghtml() {
  ...
  <header className="site-header">
    <div className="container header-inner">
      <Link className="brand" href="#top" aria-label="RoseCycle home">
        <span className="brand-mark" aria-hidden="true">
          <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16 4C12 8.3 9 12.1 9 17a7 7 0 1 0 14 0c0-4.9-3-8.7-7-13Z" stroke="currentColor" strokeWidth="2.2" strokeLinejoin="round"/>
            <path d="M16 11c-1.9 2.1-3.1 4-3.1 6.1a3.1 3.1 0 1 0 6.2 0C19.1 15 17.9 13.1 16 11Z" fill="currentColor" fill-opacity=".18" stroke="currentColor" strokeWidth="1.6"/>
          </svg>
        </span>
      ...
      <div className="nav-actions">
        ...
        <Link className="primary-button" href="#cta">Join the waitlist</Link>
      </div>
    </div>
  </header>
      ...
      <div className="container hero-grid">
        <div className="hero-copy reveal visible">
          ...
          <div className="cta-row">
            <Link className="primary-button" href="#cta">Get early access</Link>
            <Link className="outline-button" href="#features">Explore the product</Link>
          </div>
          ...
          <div className="app-shell">
            <div className="shell-top">
              <div>
                ...
                <strong >Cycle day 24 · Luteal phase</strong>
              </div>
              <div className="chip" >Calm mode on</div>
            </div>
              ...
              <div >
                <article className="insight-card">
                  <div className="insight-head">
                    <div>
                      ...
                      <div >Based on your last 4 cycles</div>
                    </div>
                ...
                <div className="mini-grid">
                  <article className="mini-card">
                    ...
                    <strong>92%</strong>
                    <small >more accurate over time</small>
                  </article>
                  <article className="mini-card">
                    <span>Daily check-in</span>
                    <strong>1 tap</strong>
                    <small >flow, mood, pain, notes</small>
                  </article>
                </div>
              </div>
            </div>
        ...
        <div className="feature-grid">
          <article className="feature-card feature-large accent-surface reveal">
            <div className="feature-icon" aria-hidden="true">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2v20M2 12h20"/><path d="M5 5l14 14" opacity=".35"/></svg>
            </div>
          ...
          <article className="feature-card reveal">
            <div className="feature-icon" aria-hidden="true">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="4"/><path d="M8 2v4M16 2v4M3 10h18"/></svg>
            </div>
          ...
          <article className="feature-card reveal">
            <div className="feature-icon" aria-hidden="true">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 12h18"/><path d="M3 6h18" opacity=".35"/><path d="M3 18h12" opacity=".55"/></svg>
            </div>
          ...
          <article className="feature-card reveal">
            <div className="feature-icon" aria-hidden="true">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M6 10a6 6 0 1 1 12 0c0 7-6 10-6 10S6 17 6 10Z"/><circle cx="12" cy="10" r="2.5"/></svg>
            </div>
          ...
          <article className="feature-card reveal">
            <div className="feature-icon" aria-hidden="true">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M8 12h8M12 8v8"/><rect x="3" y="3" width="18" height="18" rx="5"/></svg>
            </div>
    ...
    <section className="cta-band" id="cta">
      <div className="container">
        <article className="cta-card reveal">
          ...
          <h3 >A menstrual app that feels calm, smart, and deeply personal.</h3>
          ...
          <div className="cta-row">
            <Link className="primary-button" href="mailto:hello@rosecycle.app" target="_blank" rel="noopener noreferrer">Request demo</Link>
            <Link className="ghost-button" href="#top">Back to top</Link>
          </div>
        </article>
      </div>
    </section>
